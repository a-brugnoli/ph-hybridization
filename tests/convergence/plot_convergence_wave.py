...
directory_results = f"{os.path.dirname(os.path.abspath(__file__))}/results/Wave/{bc_case}/"
...
# # Plot dual
basic_plotting.plot_convergence(h_list=h_list, variable_list=error_L2_pressure_dual, 
                                label="CG", 
