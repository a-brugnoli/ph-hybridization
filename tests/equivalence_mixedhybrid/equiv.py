...
mixedsolver_primal = HamiltonianWaveSolver(problem = problem, type_system=case, pol_degree=pol_degree, \
                                    type_discretization="mixed", \
                                    type_formulation="primal")

hybridsolver_primal = HamiltonianWaveSolver(problem = problem, type_system=case, pol_degree=pol_degree, \
                                    type_discretization="hybrid", \
                                    type_formulation="primal")

mixedsolver_dual = HamiltonianWaveSolver(problem = problem, type_system=case, pol_degree=pol_degree, \
                                    type_discretization="mixed", \
                                    type_formulation="dual")

hybridsolver_dual = HamiltonianWaveSolver(problem = problem, type_system=case, pol_degree=pol_degree, \
                                    type_discretization="hybrid", \
                                    type_formulation="dual")
